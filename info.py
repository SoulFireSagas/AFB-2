...
BOT_TOKEN = environ.get('BOT_TOKEN', "7600571087:AAEY2OiwX8UxPo77e4Gfe-Kha-QsxuEXkZE")
...
PICS = (environ.get('PICS', 'https://postimg.cc/nj5zrzQ9')).split()  # Sample pic
...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://postimg.cc/nj5zrzQ9')).split()  # Fsub pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002416261527').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002434017099'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002587895235'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002641880009'))  # Notification of those who verify will be sent to your channel
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://postimg.cc/8FmPR4fG')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'san-shne@akl')
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sanjayarul2004:mBYfpzBI3iQrRF82@cluster0.64acf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sohogeh110:H1JL2qelX4HNQM3K@cluster0.utyuw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNERID = int(os.environ.get('OWNERID', '2010016480'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '2010016480').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SSadminRobot')  # Support group link (make sure bot is admin)
